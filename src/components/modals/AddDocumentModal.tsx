...
export default function AddDocumentModal() {
  ...
  const { addDocument } = documentsSlice.actions;
  ...
  const onSubmit: SubmitHandler<DocumentData> = (documentData) => {
    ...
    documentData.companySigDate = new Date().toISOString();
    documentData.employeeSigDate = new Date().toISOString();
    ...
    <Fragment>
      ...
      <Modal open={open} onClose={handleCloseModal}>
        <Box sx={style}>
          ...
          >
            <Typography variant="h5">Добавить документ</Typography>
